...
5. Add functionality to save cards in local storage and in database for long term use
6. Add Authentication and User profiles 
7. Add functionality to cards container for flash cards options
8. Fix 360 flip animation the cards for onClick
